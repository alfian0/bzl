...
BUILD_SETTINGS = BazelBuildSettings(
    '/opt/homebrew/Cellar/bazel/4.2.1_1/bin/bazel',
    '/private/var/tmp/_bazel_MA1779/51b5986986bbdee1b30baaa8c1ce30a6/execroot/__main__',
    '/private/var/tmp/_bazel_MA1779/51b5986986bbdee1b30baaa8c1ce30a6',
    'ios_x86_64',
    {
        'macos_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/MA1779/Library/Application Support/Tulsi/0.20210318.88/Bazel',
